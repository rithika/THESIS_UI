function mapr4() {
 ...
 // var color_domain = [1, 100, 500, 5000, 150000000, 300000000];
  var ext_color_domain = [50,100,250,500,1000]
  var legend_labels = ["0-50", "50-100", "100-250", "250-500", "> 500"]  
  ...
  var svg = d3.select("#mml4").append("svg")
                          .attr("width",width)
                          .attr("height",height)
  ...
  d3.json('thesis/Redhat/data/mls-timezone.json', function(data){
